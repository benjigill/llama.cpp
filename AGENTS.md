...
- #28702 CUDA fused Q4_K gate/up + SwiGLU MMQ for prefill - +4-11% pp on Qwen3.x-27B Q4_K_M upstream; under -sm tensor the meta backend skips graph_optimize, so check KLD vs master
