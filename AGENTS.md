...
- local ngram-mod table size + wipe logging - `--spec-ngram-mod-size` (MiB, default 16 = upstream) so a long-running server keeps more shared history; both table wipes (25% occupancy, low-acceptance streak) log a warning
